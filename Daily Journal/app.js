...
app.get('/',function(req,res){
  //res.render("home");  //Result that we are going to send back from the server to the user who is requesting this page
  res.render('home',{
...
app.get('/posts/:postName', function(req,res){
  ...
  posts.forEach(function(postItem){
    const storedTitle = _.lowerCase(postItem.title)
